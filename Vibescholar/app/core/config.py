...
class Settings:
    ...
    RESULTS_PER_PROVIDER: int = _positive_int("RESULTS_PER_PROVIDER", 1)
    EVIDENCE_BATCH_SIZE: int = _positive_int("EVIDENCE_BATCH_SIZE", 1)
    TARGET_STRONG_EVIDENCE: int = _positive_int("TARGET_STRONG_EVIDENCE", 1)
    MAX_PARTIAL_EVIDENCE: int = _positive_int("MAX_PARTIAL_EVIDENCE", 2)
